...
export function OrderSelectableList({
  orderIds,
  children,
}: OrderSelectableListProps) {
    ...
    <div className="space-y-4">
      {orderIds.length > 1 && (
        <div className="flex items-center gap-3 text-sm">
          <Checkbox
            checked={selected.size === orderIds.length && orderIds.length > 0}
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">
              Aggregated Summary ({selected.size} orders)
            </CardTitle>
          </CardHeader>
          <CardContent>
